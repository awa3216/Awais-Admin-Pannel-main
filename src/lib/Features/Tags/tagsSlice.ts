  ...
  async (credentials, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(
        "https://phuket.007-lagoon560.com/tags/add-tag",
        credentials,
        {
...
>(
  ...
  async (params, { rejectWithValue }) => {
    try {
      const token = localStorage.getItem("token");
      let queryString = "https://phuket.007-lagoon560.com/tags/all-tags";
  ...
  async (
    ...
    try {
      ...
      const response = await axios.get(
        `https://phuket.007-lagoon560.com/tags/tagByID?id=${tagsId}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async ({ payload, tagsId }: { payload: AddTagsPayload; tagsId: string },
    ...
    try {
      ...
      const response = await axios.put(
        `https://phuket.007-lagoon560.com/tags/edit-tag?id=${tagsId}`,
        payload,
        {
          withCredentials: true,
          headers: {
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.delete(
        `https://phuket.007-lagoon560.com/tags/delete-tag?id=${id}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${token}`,
