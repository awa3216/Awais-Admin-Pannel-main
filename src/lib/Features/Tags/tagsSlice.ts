  ...
  async (credentials, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.post(
        "https://34.201.147.207/tags/add-tag",
        credentials,
        {
...
>(
  ...
  async (params, { rejectWithValue }) => {
    try {
      const token = localStorage.getItem("token");
      let queryString = "https://34.201.147.207/tags/all-tags";
  ...
  async (
    ...
    try {
      ...
      const response = await axios.get(
        `https://34.201.147.207/tags/tagByID?id=${tagsId}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async ({ payload, tagsId }: { payload: AddTagsPayload; tagsId: string },
    ...
    try {
      ...
      const response = await axios.put(
        `https://34.201.147.207/tags/edit-tag?id=${tagsId}`,
        payload,
        {
          withCredentials: true,
          headers: {
  ...
  async (id, { rejectWithValue }) => {
    try {
      ...
      const response = await axios.delete(
        `https://34.201.147.207/tags/delete-tag?id=${id}`,
        {
          withCredentials: true,
          headers: {
            Authorization: `Bearer ${token}`,
